...
from adaprobe.optimise.mbcs_spike_weighted_var_with_outliers \
	import update_mu_constr_l1, update_isotonic_receptive_field, isotonic_filtering, update_z_l1_with_residual_tolerance
...
class Model:
	...
	def _fit_mbcs_spike_weighted_var_with_outliers(self, obs, stimuli, fit_options):
		...
		mu, beta, lam, shape, rate, z, rfs, mu_hist, beta_hist, lam_hist, shape_hist, rate_hist, z_hist, \
