...
def mbcs_spike_weighted_var_with_outliers(obs, I, mu_prior, beta_prior, shape_prior, rate_prior, phi_prior, phi_cov_prior, iters=50,
	...
	for it in tqdm(range(iters), desc='CAVI', leave=False):
		...
		z = update_z_constr_l1(y - z, mu, lam, shape, rate, lam_mask, penalty=outlier_penalty, scale_factor=scale_factor,
